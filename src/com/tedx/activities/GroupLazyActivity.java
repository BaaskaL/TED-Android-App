...
public abstract class GroupLazyActivity extends Activity implements OnItemClickListener {
	...
	protected GroupLazyAdapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState, int layoutResId, int rowLayoutResId) {		
		...
		mAdapter = new GroupLazyAdapter(this, mAdapterData, rowLayoutResId, mFrom, mTo);
	...
	private static class LoadImageTask extends AsyncTask<String, Integer, Boolean> {
		public GroupLazyActivity activity;
		private String mUrl;
